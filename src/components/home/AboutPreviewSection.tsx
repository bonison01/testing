      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col lg:flex-row items-center gap-12">
          <div className="w-full lg:w-1/2 order-2 lg:order-1">
            <h2 className="text-3xl md:text-4xl font-bold mb-6 lg:text-left">About Mateng Hub Connect</h2>
            <p className="text-gray-600 mb-4 lg:text-left">
              Established in December 2022, Mateng Hub Connect has rapidly grown into a leading hyperlocal delivery company with a mission to bring communities closer together.
            </p>
