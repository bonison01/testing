    ...
    <section className="mateng-section bg-gradient-to-r from-indigo-600 to-purple-600 text-white relative">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center mb-10">
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-4">June 2025 Mathematics Competition</h2>
          <p className="text-lg md:text-xl max-w-2xl mx-auto">
            Join our exciting mathematics competition for Classes 4 & 5 with amazing prizes and opportunities to showcase your talent.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
          ...
          <div className="bg-white/10 backdrop-blur-sm p-6 rounded-lg hover-card">
            <h3 className="text-xl font-bold mb-3">Two Categories</h3>
            <p className="text-gray-200">
              Separate competitions for Class 4 and Class 5 students with age-appropriate challenges.
            </p>
          </div>
