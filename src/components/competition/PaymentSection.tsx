      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        <div>
          ...
          <div className="bg-gray-50 p-4 rounded-lg border text-center">
            ...
            <div className="w-40 h-40 mx-auto bg-white flex items-center justify-center mb-2">
              <img
                src="https://lhzwholxmjolpinyxxsz.supabase.co/storage/v1/object/public/competition_documents/aadhaar/QR.jpeg"
                alt="QR Code"
                className="w-full h-full object-contain"
              />
            </div>
            <div className="text-sm font-medium">UPI ID: doeasy01-1@okicici</div>
          </div>
